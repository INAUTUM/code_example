...
int main() {
    ...
    LL n = 9;
    forn(i, user){
        fs::create_directory("/Users/inautum/Desktop/matr/" + to_string(i));
        forn(j, user){
            string cmd = "/Users/inautum/Desktop/matr/" + to_string(i) + '/' + '9' + '_' + to_string(i) + '_' + to_string(j) + ".txt";
            ofstream oFile(cmd);
            system(("openssl rand -out " + cmd + " -base64 339").c_str());
        }
    }
}